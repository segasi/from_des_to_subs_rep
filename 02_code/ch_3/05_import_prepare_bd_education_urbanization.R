...
# The following code most be executed only if you don't have the files in your local disk

# Define suffix with states acronyms 
# states <- c("ags", "bc", "bcs", "cam",
#           "coah", "col", "chis", "chih",
#           "cdmx", "dgo", "gto", "gro",
#           "hgo", "jal", "mex", "mich",
#           "mor", "nay", "nl", "oax",
...
# Define the first part of the name of the variables that have to be downloaded

# variables <- c("01_poblacion_")

# Downloaded files to 01_data/ch_3/inegi/urbanization/encuesta_intercensal_2015/ 
# for (i in seq_along(states)) {
#   for (j in seq_along(variables)) {
#     curl::curl_download(paste("https://www.inegi.org.mx/contenidos/programas/intercensal/2015/tabulados/", variables[j], states[i], ".xls", sep = ""), destfile = paste("01_data/ch_3/inegi/encuesta_intercensal_2015/", variables[j], states[i], ".xls", sep = ""))
#     
#   }
# }
